...
def stageParam(): #hardcoded Titan II ICBM
  stages = 2
  dryMass     = [4319, 2301] #kg
  wetMass     = [121200, 28400] #kg
  isp         = [273, 316] #specific impulse by weight (seconds)
...
if GRAPH:
  ...
  plt.title("Rocket Performance: Payload vs. Δv, Titan II (ICBM)")
  plt.legend(loc='best')
  plt.grid(True)
  plt.tight_layout()
  ...
  plt.title("Δv Sensitivity to Payload, Titan II (ICBM)")
