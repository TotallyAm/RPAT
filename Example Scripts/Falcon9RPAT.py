...
def stageParam(): #hardcoded for Falcon 9 FT
  stages = 2
  dryMass     = [133500, 4000] #kg
  wetMass     = [520500, 111500] #kg
  isp         = [311, 348] #specific impulse by weight (seconds)
...
if GRAPH:
  ...
  plt.title("Rocket Performance: Payload vs. Δv, Falcon 9 FT")
  plt.legend(loc='best')
  plt.grid(True)
  plt.tight_layout()
  ...
  plt.title("Δv Sensitivity to Payload, Falcon 9 FT")
