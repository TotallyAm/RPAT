...
def stageParam(): #hardcoded for Rocket Lab Electron
  stages = 2
  dryMass     = [3250, 250] #kg
  wetMass     = [12550, 2300] #kg
  isp         = [311, 333] #specific impulse by weight (seconds)
...
if GRAPH:
  ...
  plt.title("Rocket Performance: Payload vs. Δv, Electron (Rocketlab)")
  plt.legend(loc='best')
  plt.grid(True)
  plt.tight_layout()
  ...
  plt.title("Δv Sensitivity to Payload, Electron (Rocketlab)")
